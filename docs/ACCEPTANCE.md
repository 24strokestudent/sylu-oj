...
> **当前状态（2026-09-21）：允许 IP 内测，不允许公网生产上线。**
> 已达成：Hydro 装好、品牌落地、IP 首页与关键路由可达、题库导入、C++/Python 判题、WA/TLE、MongoDB/沙箱端口隔离、备份与临时库恢复核对。
> 仍缺：生产域名与受信任 HTTPS 证书、异地备份副本、完整人工恢复启动演练、教师作业/比赛链路和全部沙箱网络用例。
